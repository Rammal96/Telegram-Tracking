    ...
    <div className="min-h-screen bg-black text-white p-8">
      <div className="max-w-4xl mx-auto">
          ...
          {REGIONS.map((region) => (
            <div key={region.slug} className="bg-gray-900 border border-yellow-400/30 rounded-lg p-6">
              ...
              <div className="space-y-3">
                <div>
                  <label className="text-gray-400 text-sm mb-1 block">Markdown (for Telegram, Discord, etc.):</label>
                ...
                <div>
                  <label className="text-gray-400 text-sm mb-1 block">HTML:</label>
                  <div className="flex gap-2">
                    <code className="flex-1 bg-gray-800 p-3 rounded text-sm text-gray-300 break-all">
                ...
                <div>
                  <label className="text-gray-400 text-sm mb-1 block">Plain URL:</label>
                  <div className="flex gap-2">
                    <code className="flex-1 bg-gray-800 p-3 rounded text-sm text-gray-300 break-all">
        ...
        <div className="mt-8 p-4 bg-yellow-900/30 border border-yellow-400/30 rounded-lg">
          <p className="text-yellow-400 font-semibold mb-2">How to use:</p>
          <ul className="text-gray-300 text-sm space-y-1 list-disc list-inside">
            <li><strong>Markdown:</strong> Use in Telegram, Discord, Reddit, etc. - Shows as clickable "New Maestro Tweet"</li>
            <li><strong>HTML:</strong> Use in emails, websites, etc. - Shows as clickable "New Maestro Tweet"</li>
            <li><strong>Plain URL:</strong> Just paste the link - Telegram will show a preview with "New Maestro Tweet" title</li>
          </ul>
        </div>
      </div>
    </div>
